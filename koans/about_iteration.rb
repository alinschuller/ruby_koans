...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Takes a block that will be executed for every element
    # in the object we called the inject method on
    # So since we have 3 elements, our block will be executed 3 times
    # when we inject 0 in the first example, that is basically the initial value of sum
    # when we inject 1 in the second example, that is the initial value of product (so first parameter)
  end
