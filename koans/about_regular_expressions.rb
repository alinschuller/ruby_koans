...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # almost never unless we have something before or after that does not match like ab*c cannot match azc because b* does not match z and c does not match zc
  end
  ...
  # ------------------------------------------------------------------
  # with [] we have the OR operator at the character level
  # with (|) we have the OR operator at the pattern level
  # (true|false) searched true or false
  # ([Tt]rue|[Ff]alse) will search True OR true OR False OR false
