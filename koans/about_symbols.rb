...
class AboutSymbols < Neo::Koan
  ...
  # a symbol is just a number referred to by a name, so when we compare two symbols, we compare the object ids and not their content
  ...
  # the stay in memory until the program exits
end
